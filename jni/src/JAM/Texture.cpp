...
JAM_Texture::JAM_Texture(SDL_Renderer* renderer, int r, int g, int b)
{
...
JAM_Texture::JAM_Texture(std::string fileLocation, SDL_Renderer* renderer)
{
...
JAM_Texture::JAM_Texture(std::string fileLocation, SDL_Renderer* renderer, bool magentaAlpha)
{
	/*Loads the image as a surface*/
...
void JAM_Texture::pushToScreen(SDL_Renderer* renderer, int x, int y)
{
...
void JAM_Texture::pushToScreen(SDL_Renderer* renderer, int x, int y, int width, int height)
{
	/*create the destination rectangle of the texture*/
	SDL_Rect destRect;
	destRect.x = x; /*destination x coordinate*/
...
void JAM_Texture::pushSpriteToScreen(SDL_Renderer* renderer, int x, int y, int srcX, int srcY, int srcWidth, int srcHeight)
{
	/*create the destination rectangle of the texture*/
	SDL_Rect destRect;
	destRect.x = x; /*destination x coordinate*/
...
void JAM_Texture::pushSpriteToScreen(SDL_Renderer* renderer, int x, int y, int srcX, int srcY, int srcWidth, int srcHeight, int width, int height)
{
	/*create the destination rectangle of the texture*/
	SDL_Rect destRect;
	destRect.x = x; /*destination x coordinate*/
